...
| `sj_publication_titles` | If the file was associated with a paper, the title of the paper(s). | 
| `sj_pub_accessions`    | If the file was associated with a paper, the related St. Jude Cloud accession number(s). These group files into the publications as displayed on the Genomics Platform data browser. |
...
| `attr_germline_sample` | If available, the germline sample that was used when creating the Somatic VCF file. |
